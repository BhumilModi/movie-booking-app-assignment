  ...
  return (
    <div className="w-1/5 h-full bg-gray-200 flex flex-col">
      ...
      <div className="flex flex-col justify-between  flex-1">
        <ul>
          <li className="w-[80%] mx-auto px-5 h-10 border-black border-2 rounded-md text-[24px] my-5 cursor-pointer bg-black text-white ">
            Booked
          </li>
          <li className="bg-white w-[80%] mx-auto px-5 h-10 border-black border-2 rounded-md text-[24px] my-5 cursor-pointer">
            Book Ticket
          </li>
        </ul>
        <div
