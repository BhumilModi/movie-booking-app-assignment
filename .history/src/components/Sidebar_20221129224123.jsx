  ...
  return (
    <div className="w-1/5 h-full bg-gray-200 flex flex-col">
      <div className="flex flex-col justify-center items-center my-10 px-10 h-[20vh] ">
        ...
        <div className="text-2xl font-semibold">Bhumil Modi DharmeshKumar</div>
      ...
      <div className="flex flex-col justify-between  flex-1">
        ...
        <div className="bg-white w-[80%] mx-auto px-5 h-10 border-black border-2 rounded-md text-[24px] mb-10">
          Logout
        </div>
      </div>
    </div>
